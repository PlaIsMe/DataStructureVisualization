...
{
    uniform_int_distribution random_range(1, square_rect.h / 10 - 1);
    main_vector.clear();
        ...
        if (!is_sorting)
        {
            if (event.type == SDL_QUIT) {
                ...
                if (change_hovered) {
                    ...
                    sort_thread = std::thread(&Sort::selectionSort, this, std::ref(renderer));
...
void Sort::selectionSort(SDL_Renderer*& renderer)
{
